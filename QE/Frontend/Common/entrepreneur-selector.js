...
(function() {
  ...
  function initEntrepreneurSelector() {
    ...
    // IMPORTANT: Sauvegarder le username original du coach/direction AVANT qu'il soit écrasé
    // par la sélection d'un entrepreneur. Ce username est utilisé pour identifier qui écrit les messages.
    if (isCoachOrDirection && !localStorage.getItem('loggedInUsername')) {
      ...
      if (currentUsername) {
        ...
        console.log('[ENTREPRENEUR-SELECTOR] 💾 loggedInUsername sauvegardé:', currentUsername);
      }
    }
