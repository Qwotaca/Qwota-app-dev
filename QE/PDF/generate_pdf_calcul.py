...
def generate_calcul_pdf(data: dict) -> BytesIO:
    """
    Génère un PDF de calculateur basé sur les données du calculateur Qwota
    Utilise le template templatecalcul.pdf
    """
    ...
    template_path = "QE/PDF/pdf/templatecalcul.pdf"
    ...
    # Page 2 - Intérieur (utilise la page 2 du template si elle existe)
    try:
