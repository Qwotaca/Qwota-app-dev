...
# Trouver où se termine le vrai HTML (avant </body>)
body_close_index = content.rfind('</body>')
html_close_index = content.rfind('</html>')

# Le script propre à ajouter (sans les lignes parasites)
clean_script = """
<script>
...
# Extraire le contenu avant </body>
clean_content = content[:body_close_index]

# Ajouter le script propre, puis </body></html>
final_content = clean_content + clean_script + "\n</body>\n</html>\n"
